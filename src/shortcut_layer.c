...
layer_t make_shortcut_layer(int batch, int index, int w, int h, int c, int w2, int h2, int c2)
{
...
#ifdef GPU
void forward_shortcut_layer_gpu(const layer_t l, network_state state)
{
...
void backward_shortcut_layer_gpu(const layer_t l, network_state state)
{
